...
const sliding = function() {
    ...
    const goToSlide = function(slide) {
        slides.forEach((s, i)=>s.style.transform = `translateX(${100 * (i - slide)}%)` //slide=curslide
        );
    };
    //next slide
...
const trymusic = async function() {
    const fetch1 = await fetch(`https://api.spotify.com/v1/search?q=justin%20bieber&type=artist&market=ES&limit=10&offset=5`);
    const res = await fetch1.json();
    console.log(res);
};
trymusic();

},{"core-js/modules/web.immediate.js":"49tUX","./model.js":"dEDha","url:../img/icons.svg":"7PFwx","regenerator-runtime/runtime":"dXNgZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
},{}],"7PFwx":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bWBrl") + "icons.a23457cd.svg" + "?" + Date.now();
...
},{}]},["6KagL","gCE4p"], "gCE4p", "parcelRequire69fa")
